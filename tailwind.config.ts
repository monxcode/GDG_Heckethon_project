    ...
    extend: {
      ...
      keyframes: {
        ...
        "border-glow": {
          ...
          "33%": { borderColor: "hsl(var(--neon-pink))" },
          "66%": { borderColor: "hsl(var(--neon-green))" },
        },
      },
      animation: {
      ...
      backgroundImage: {
        ...
        "neon-gradient": "linear-gradient(135deg, hsl(var(--neon-cyan)), hsl(var(--neon-pink)), hsl(var(--neon-green)))",
      },
    },
  },
